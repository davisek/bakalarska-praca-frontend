...
<template>
  <div class="flex flex-col items-center p-10 text-center space-y-4">
    <div class="mb-10">
      ...
      <h1 class="text-3xl">SensorDataApp</h1>
    </div>
    <!-- Profile dropdown -->
    <Menu as="div" class="relative">
      <div>
        <MenuButton class="relative flex rounded-full bg-gray-800 text-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
