    ...
    <div v-for="group in groups" :key="group.group_value" class="mb-12 sensor-group">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <router-link
            ...
            :class="['sensor-card group relative overflow-hidden', sensor.color_class.value || 'default-card', isDarkMode ? 'dark-sensor-card' : 'light-sensor-card']"
        >
          ...
          <div class="relative z-10 flex flex-col h-full">
            <div class="flex items-center mb-4">
              ...
              <h3 :class="['ml-3 text-xl font-bold', isDarkMode ? 'text-white' : 'text-black']">{{ sensor.display_name || sensor.sensor_name }}</h3>
            </div>
            ...
            <div :class="['flex justify-end items-center mt-4 text-sm opacity-70', isDarkMode ? 'text-gray-400' : 'text-gray-800']">
...
.light-sensor-card {
  @apply p-6 rounded-xl shadow-lg duration-300;
  @apply bg-gradient-to-br from-gray-200/95 to-gray-300/95;
  @apply border border-gray-400/50;
  @apply hover:shadow-2xl hover:border-purple-500/30 hover:scale-[1.02];
  animation: slideIn 0.5s ease-out;
}
