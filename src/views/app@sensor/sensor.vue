      ...
      <div class="lg:col-span-1 col-span-3">
        ...
        <div class="flex justify-center items-center h-full">
          <transition name="fade-down" mode="out-in">
            ...
            >
              <div class="lg:w-5/6 w-full bg-gray-900 rounded-full h-5/6 flex justify-center items-center text-center shadow-box">
                <component :is="sections[0].component" :sensor="props.sensor" />
              </div>
            </div>
          </transition>
        </div>
